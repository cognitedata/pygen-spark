...
**Dedicated / Private Link / PSaaS / `europe-west1-1`:** [§1 base URL](./deployment.md#1-i-need-my-base-url), [§2 TOML](./deployment.md#2-i-need-toml). Requires **cognite-pygen** ≥ 1.3.0.
